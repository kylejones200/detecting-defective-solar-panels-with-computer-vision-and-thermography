"""Run CLIP zero-shot classification on the faulty solar panel dataset."""
...
def clip_zero_shot_faulty_panel(ctx: PipelineContext) -> None:
    ...
    for images, labels in val_ds.take(1):
        ...
        for i in range(min(16, len(images))):
            ...
            plt.axis("off")
    plt.tight_layout()
    finalize_plot(ctx, "11_clip_zero_shot_faulty_panel")
