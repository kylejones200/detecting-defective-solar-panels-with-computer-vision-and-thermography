...
def main():
    ...
    ax1.axvline(
        x=best_epoch, color=COLORS["accent_blue"], linestyle=":", linewidth=1.5, alpha=0.7
    )
    ax1.annotate(
    ...
    ax.text(
        ...
        bbox=dict(
            boxstyle="round", facecolor="white", edgecolor=COLORS["black"], linewidth=1.5
        ),
    )
    ...
    ax.set_title(
        "Precision-Recall Curve: High Performance on Imbalanced Data", pad=15, fontsize=13
    )
    ax.set_xlim(0, 1)
    ax.set_ylim(0, 1)
